...
void eff(string dir, string sample)
{
  ...
  TH1F *h_phi_reco_SPi = new TH1F("h_phi_reco_SPi", ";#phi; reconstructed Events", 20, -3.5, 3.5);
  TH1F *h_phi_reco_Pi = new TH1F("h_phi_reco_Pi", ";#phi; reconstructed Events", 20, -3.5, 3.5);
  TH1F *h_phi_reco_K = new TH1F("h_phi_reco_K", ";#phi; reconstructed Events", 20, -3.5, 3.5);
  TH1F *h_phi_reco_D0 = new TH1F("h_phi_reco_D0", ";#phi; reconstructed Events", 20, -3.5, 3.5);
  TH1F *h_phi_reco_Dst = new TH1F("h_phi_reco_Dst", ";#phi; reconstructed Events", 20, -3.5, 3.5);
  TH1F *h_phi_SPi = new TH1F("h_phi_SPi", ";#phi;Events", 20, -3.5, 3.5);
  TH1F *h_phi_Pi = new TH1F("h_phi_Pi", ";#phi;Events", 20, -3.5, 3.5);
  TH1F *h_phi_K = new TH1F("h_phi_K", ";#phi;Events", 20, -3.5, 3.5);
  TH1F *h_phi_D0 = new TH1F("h_phi_D0", ";#phi;Events", 20, -3.5, 3.5);
  TH1F *h_phi_Dst = new TH1F("h_phi_Dst", ";#phi;Events", 20, -3.5, 3.5);

  TH1F *h_eta_reco_SPi = new TH1F("h_eta_reco_SPi", ";#eta; reconstructed Events", 20, 2.0, 4.5);
  TH1F *h_eta_reco_Pi = new TH1F("h_eta_reco_Pi", ";#eta; reconstructed Events", 20, 2.0, 4.5);
  TH1F *h_eta_reco_K = new TH1F("h_eta_reco_K", ";#eta; reconstructed Events", 20, 2.0, 4.5);
  TH1F *h_eta_reco_D0 = new TH1F("h_eta_reco_D0", ";#eta; reconstructed Events", 20, 2.0, 4.5);
  TH1F *h_eta_reco_Dst = new TH1F("h_eta_reco_Dst", ";#eta; reconstructed Events", 20, 2.0, 4.5);
  TH1F *h_eta_SPi = new TH1F("h_eta_SPi", ";#eta;Events", 20, 2.0, 4.5);
  TH1F *h_eta_Pi = new TH1F("h_eta_Pi", ";#eta;Events", 20, 2.0, 4.5);
  TH1F *h_eta_K = new TH1F("h_eta_K", ";#eta;Events", 20, 2.0, 4.5);
  TH1F *h_eta_D0 = new TH1F("h_eta_D0", ";#eta;Events", 20, 2.0, 4.5);
  TH1F *h_eta_Dst = new TH1F("h_eta_Dst", ";#eta;Events", 20, 2.0, 4.5);

  TH1F *h_theta_reco_SPi = new TH1F("h_theta_reco_SPi", ";#theta; reconstructed Events", 20, 0.02, 0.2);
  TH1F *h_theta_reco_Pi = new TH1F("h_theta_reco_Pi", ";#theta; reconstructed Events", 20, 0.02, 0.24);
  TH1F *h_theta_reco_K = new TH1F("h_theta_reco_K", ";#theta; reconstructed Events", 20, 0.02, 0.24);
  TH1F *h_theta_reco_D0 = new TH1F("h_theta_reco_D0", ";#theta; reconstructed Events", 20, 0.02, 0.2);
  TH1F *h_theta_reco_Dst = new TH1F("h_theta_reco_Dst", ";#theta; reconstructed Events", 20, 0.02, 0.2);
  TH1F *h_theta_SPi = new TH1F("h_theta_SPi", ";#theta;Events", 20, 0.02, 0.2);
  TH1F *h_theta_Pi = new TH1F("h_theta_Pi", ";#theta;Events", 20, 0.02, 0.24);
  TH1F *h_theta_K = new TH1F("h_theta_K", ";#theta;Events", 20, 0.02, 0.24);
  TH1F *h_theta_D0 = new TH1F("h_theta_D0", ";#theta;Events", 20, 0.02, 0.2);
  TH1F *h_theta_Dst = new TH1F("h_theta_Dst", ";#theta;Events", 20, 0.02, 0.2);
