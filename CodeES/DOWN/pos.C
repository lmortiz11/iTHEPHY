...
if (sPi_ID<0)
{
   sPi_neg++;
    ...
    Double_t eff_Dst_pos_rec=Dst_pos_rec/nentries;
    Double_t eff_Dst_neg=Dst_neg/nentries;*/
 
    // print the number of recontructed events for each particle;
    Double_t P1_pos_err=(1/P1_pos)*sqrt(P1_pos_rec*(P1_pos-P1_pos_rec)/P1_pos);
    Double_t P1_neg_err=(1/P1_neg)*sqrt(P1_neg_rec*(P1_neg-P1_neg_rec)/P1_neg);
 
    Double_t P2_pos_err=(1/P2_pos)*sqrt(P2_pos_rec*(P2_pos-P2_pos_rec)/P2_pos);
    Double_t P2_neg_err=(1/P2_neg)*sqrt(P2_neg_rec*(P2_neg-P2_neg_rec)/P2_neg);
 
    Double_t sPi_pos_err=(1/sPi_pos)*sqrt(sPi_pos_rec*(sPi_pos-sPi_pos_rec)/sPi_pos);
    Double_t sPi_neg_err=(1/sPi_neg)*sqrt(sPi_neg_rec*(sPi_neg-sPi_neg_rec)/sPi_neg);
    ...
    Double_t Dst_pos_rec_err=(1/nentries)*sqrt(Dst_pos_rec*(nentries-Dst_pos_rec)/nentries);
   ...
   /* cout<<"D0 pos efficiency: "<<eff_D0_pos <<" +- "<< D0_pos_err<<'\n';
    ...
    cout<<"D*+ pos efficiency: "<<eff_Dst_pos_rec <<" +- "<< Dst_pos_rec_err<<'\n';
